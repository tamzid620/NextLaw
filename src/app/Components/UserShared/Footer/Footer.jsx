...
const Footer = () => {
  ...
  return (
    <footer className={` ${open_sans.className} bg-[#124547] text-white py-14`}>
      <main className="lg:max-w-6xl md:max-w-3xl sm: max-w-sm md:mx-auto sm: mx-4 lg:text-start md:text-center sm: text-center grid lg:grid-cols-4 md:grid-cols-2 sm: grid-cols-1 gap-10">
        {/* grid div -1  */}
        <div>
          <h1 className={` ${cormorant.className} text-3xl mb-5 `}>About Us</h1>
        ...
        {/* grid div -2  */}
        <div>
          <h1 className={` ${cormorant.className} text-3xl mb-5 `}>Our Expertise</h1>
          <div>
            {expertise.map(({ path, name }, index) => (
              <ul key={index}>
                <li className="flex lg:justify-start md:justify-center sm: justify-center items-center hover:underline md:text-sm sm: text-xs md:px-0 sm: px-2 mb-3">
                  {" "}
                  <Image src={arrowLogo} alt="star logo" className="w-4 me-2" />{" "}
                  {name}
                </li>
              </ul>
            ))}
        ...
        {/* grid div -3  */}
        <div>
          <h1 className={` ${cormorant.className} text-3xl mb-5 `}>Dhaka Office</h1>
          <div>
        ...
        {/* grid div -4  */}
        <div>
          <h1 className={` ${cormorant.className} text-3xl mb-5 `}>Chattogram Office</h1>
          <div>
